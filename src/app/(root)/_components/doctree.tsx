    ...
    <div className="flex flex-col gap-2 px-2">
      ...
      >
        <span className="flex grow items-center text-muted-foreground hover:text-foreground transition-colors ease-in-out duration-300 cursor-pointer">
          <SearchIcon className="-ms-1 me-3" size={16} aria-hidden="true" />
      ...
      <Link
        href={"/home"}
        className={cn(buttonVariants({ variant: "secondary" }), "bg-transparent dark:hover:bg-[#FFFFFF0E] h-10")}
      >
        <span className="flex grow items-center text-muted-foreground hover:text-foreground transition-colors ease-in-out duration-300 cursor-pointer">
          <Home className="-ms-1 me-3" size={16} aria-hidden="true" />
      ...
      <span
        className={cn(
          ...
          "group/item bg-transparent dark:hover:bg-[#FFFFFF0E] h-10 pl-3 pr-2"
        )}
      >
        <span className="flex grow items-center text-muted-foreground hover:text-foreground transition-colors ease-in-out duration-300 cursor-pointer">
          ...
          <TooltipProvider delayDuration={0}>
            <Tooltip>
              <TooltipTrigger asChild>
                <Button
                  variant={"ghost"}
                  className="size-7 cursor-pointer dark:hover:bg-neutral-900 opacity-0 group-hover/item:opacity-100 transition duration-300 ease-in-out"
      ...
      <div
        onClick={() => handleCreateDocument({})}
        className={cn(
          "group/item cursor-pointer bg-transparent hover:bg-gray-200 dark:hover:bg-[#FFFFFF0E] p-2 rounded-md gap-3 flex"
        )}
      >
        <Plus />
      ...
      >
        <span className="flex grow items-center text-muted-foreground hover:text-foreground transition-colors ease-in-out duration-300 cursor-pointer">
          <Settings className="-ms-1 me-3" size={16} aria-hidden="true" />
